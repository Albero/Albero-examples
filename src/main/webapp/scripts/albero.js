		...
		createForm: function(formDescriptor) {
			...
			var addTooltip = Utilities.bind(this, function(parent, descriptor, type) {
				if (descriptor.renderedTexts[type]) {
					...
					tooltipElement.className='tooltipspot';

                    var tooltipText = descriptor.renderedTexts[type];

                    Utilities.addEventListener(tooltipElement, 'mouseover', Utilities.bind(this, function(event) {
                        this.notifyListeners('showTooltip', [tooltipText, tooltipElement]);
                    }));
                    Utilities.addEventListener(tooltipElement, 'mouseout', Utilities.bind(this, function(event) {
                        this.notifyListeners('hideTooltip', [tooltipText, tooltipElement]);
                    }));
